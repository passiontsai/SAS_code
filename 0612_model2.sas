...
proc countreg data = work.all_size_5 groupid=gvkey;
 model p_count = Abs_RD_Intensity k_div exp_ratio Dynamism_sale Dynamism_operating Dynamism_all Munificence_sale
...
proc countreg data = work.all_size_5 groupid=gvkey;
 model p_citation = Abs_RD_Intensity k_div exp_ratio Dynamism_sale Dynamism_operating Dynamism_all Munificence_sale
...
proc countreg data = work.all_size_5 groupid=gvkey;
 model new = Abs_RD_Intensity k_div exp_ratio Dynamism_sale Dynamism_operating Dynamism_all Munificence_sale
...
proc countreg data = work.all_size_5 groupid=gvkey;
 model copy = Abs_RD_Intensity k_div exp_ratio Dynamism_sale Dynamism_operating Dynamism_all Munificence_sale
...
proc countreg data = work.all_size_5 groupid=gvkey;
 model emerge = Abs_RD_Intensity k_div exp_ratio Dynamism_sale Dynamism_operating Dynamism_all Munificence_sale
